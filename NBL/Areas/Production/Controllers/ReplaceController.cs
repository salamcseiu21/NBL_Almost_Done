    ...
    public class ReplaceController : Controller
    {
        ...
        public void SaveScannedBarcodeToTextFile(string barcode, long replaceId)
        {
            ...
            try
            {
                ...
                List<ViewFactoryStockModel> products = (List<ViewFactoryStockModel>)Session["Factory_stock12"];
                var id = replaceId;
                ...
                if (barcodeList.Count != 0)
                {
                    foreach (ScannedProduct scannedProduct in barcodeList)
                    {
                        ...
                        products.Remove(p);
                        Session["Factory_stock12"] = products;
                    }
                }
        ...
        private string GetTempReplaceProductXmlFilePath(long replaceId)
        {
            ...
            var filePath = Server.MapPath("~/Areas/Production/Files/Replaces/" + fileName);
            return filePath;
        }
